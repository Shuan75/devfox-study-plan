...
@SuppressWarnings("unchecked") // TODO: Map -> Object変換LogicがあってGenericTypeCasting問題を無視する
public record KakaoOAuth2Response(
    ...
    // InnerClassがここだけ使わず、外のServiceLogicでも呼び出すとJavaClassFileで作った方がいい
    public record KakaoAccount(
        ...
        public static KakaoAccount from(Map<String, Object> attributes) {
            return new KakaoAccount(
                    // String.valueOfはObjectがnull時 NullStringで変換して出すNullSafeLogicがある
                    // だから単純なTypeCastingではなくWrapperClassが支援してくれるのを活用
